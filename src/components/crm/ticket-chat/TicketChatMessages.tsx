      ...
      <div className="flex justify-center mb-4">
        <div className="max-w-[85%] w-full">
          ...
          <div className="flex items-center justify-center mb-2">
            <div className="flex items-center gap-2 bg-gradient-to-r from-orange-100 to-amber-100 dark:from-orange-900/30 dark:to-amber-900/30 px-4 py-2 rounded-full border border-orange-200 dark:border-orange-700 shadow-sm">
          ...
          <div className="group relative">
            ...
            {isFavorite && (
              <div className="absolute inset-0 rounded-xl ring-2 ring-yellow-400 ring-opacity-50 pointer-events-none" />
            )}
            ...
            <div className={cn(
              ...
              <div className="absolute top-3 right-3">
                <div className="flex items-center gap-1 bg-orange-200/80 dark:bg-orange-800/80 px-2 py-1 rounded-full">
              ...
              <div className="absolute -top-3 -right-3 opacity-0 group-hover:opacity-100 transition-all duration-300 flex gap-1">
                <button
                  ...
                  className={cn(
                    "p-2 rounded-full shadow-lg transition-all duration-200 transform hover:scale-110",
                    isFavorite
                ...
                <button
                  ...
                  className="p-2 rounded-full bg-white dark:bg-gray-700 text-orange-600 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-gray-600 shadow-lg transition-all duration-200 transform hover:scale-110"
