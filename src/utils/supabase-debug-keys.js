...
export function debugSupabaseKeys() {
    ...
    const windowEnvKey = window.env?.VITE_SUPABASE_ANON_KEY;
    foundKeys.push({
        source: 'window.env',
        key: windowEnvKey,
...
export function clearAllSupabaseCaches() {
...
window.debugSupabaseKeys = debugSupabaseKeys;
window.clearAllSupabaseCaches = clearAllSupabaseCaches;
