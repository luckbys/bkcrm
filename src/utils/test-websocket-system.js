...
export const diagnoseProductionWebSocket = async () => {
    ...
    for (const url of urlsToTest) {
        try {
            ...
            console.error(`❌ [PROD-DIAGNOSE] ${url} falhou:`, error.message);
        }
    }
    ...
    for (const wsUrl of websocketUrls) {
        ...
        try {
            ...
            console.error(`❌ [PROD-DIAGNOSE] Erro ao testar WebSocket ${wsUrl}:`, error.message);
        }
    }
...
if (typeof window !== 'undefined') {
    window.testWebSocketSystem = testWebSocketSystem;
