...
export const diagnoseMessagesIssue = async () => {
...
export const testMessageSending = async (ticketId, content = 'Teste de mensagem') => {
...
export const monitorMessages = () => {
    ...
    if (chatStore?.socket) {
        ...
        chatStore.socket.on('new-message', (message) => {
...
window.diagnoseMessagesIssue = diagnoseMessagesIssue;
window.testMessageSending = testMessageSending;
window.monitorMessages = monitorMessages;
