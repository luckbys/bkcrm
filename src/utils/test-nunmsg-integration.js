 ...
 */
function extractPhoneFromTicket(ticket) {
...
if (typeof window !== 'undefined') {
    window.testPhoneExtraction = testPhoneExtraction;
    window.testCreateTicketWithNunmsg = testCreateTicketWithNunmsg;
    window.cleanupTestTickets = cleanupTestTickets;
