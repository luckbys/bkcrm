...
if (typeof window !== 'undefined') {
  (window as any).testProductionWebSocket = testProductionWebSocket;
  (window as any).testCurrentChatStore = testCurrentChatStore;
  (window as any).debugWebSocketConfig = debugWebSocketConfig;
