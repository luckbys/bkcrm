...
declare global {
  interface Window {
    diagnoseDepartmentSystem: () => Promise<void>
    testDepartmentEdit: () => Promise<void>
    checkDepartmentsTable: () => Promise<void>
    testCreateDepartment: () => Promise<void>
    fixDepartmentMapping: () => Promise<void>
  }
}
