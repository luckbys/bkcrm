...
export class UnifiedChatTester {
    ...
    testTypingIndicator() {
        ...
        const users = [
            { id: '1', name: 'João Silva', role: 'client' },
            { id: '2', name: 'Maria Santos', role: 'agent' },
            { id: '3', name: 'Pedro Costa', role: 'client' }
        ];
...
if (typeof window !== 'undefined') {
    ...
    window.testUnifiedChatFeature = (feature) => unifiedChatTester.runSpecificTest(feature);
