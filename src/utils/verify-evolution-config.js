                    ...
                    try {
                        ...
                        if (instancesResponse.ok) {
                            ...
                            status.instances = Array.isArray(instancesData) ?
                                instancesData.map((inst) => inst.instance?.instanceName || 'unknown') :
                                [];
                        }
                    }
                    catch (error) {
...
window.checkEvolutionAPI = async () => {
...
window.testQRCodeAPI = async (instanceName = 'atendimento-ao-cliente-suporte') => {
    const evolutionUrl = import.meta.env.VITE_EVOLUTION_API_URL;
    const apiKey = import.meta.env.VITE_EVOLUTION_API_KEY;
