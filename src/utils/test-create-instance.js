...
window.testCreateInstanceQuick = testCreateInstanceQuick;
window.verifyWhatsAppConfig = verifyWhatsAppConfig;
window.testCreateInstanceFinal = testCreateInstanceFinal;
// Configurar helper
console.log(`
