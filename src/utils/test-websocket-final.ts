...
export async function testWebSocketFinal(): Promise<void> {
  ...
  const availableFunctions = diagnosticFunctions.filter(fn => typeof (window as any)[fn] === 'function');
...
if (typeof window !== 'undefined') {
  (window as any).testWebSocketFinal = testWebSocketFinal;
