...
import { Message, ChatInputEvent } from '@/types/chat.types';
...
const ChatInput: React.FC<ChatInputProps> = ({ ticketId, onMessageSent }) => {
  ...
  const handleKeyPress = (e: ChatInputEvent) => {
