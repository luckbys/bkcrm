...
/**
 * Utilitários para migrações e verificação de schema
 */

declare global {
  interface Window {
    checkTableSchema: (tableName: string) => Promise<void>;
    addWhatsAppFieldsToTickets: () => Promise<void>;
    verifyTicketsTable: () => Promise<void>;
    fixTicketsConstraints: () => Promise<void>;
  }
}
 ...
 */
window.checkTableSchema = async (tableName: string) => {
